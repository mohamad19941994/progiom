...
<head><base href="../../../">
    ...
    <link href="{{asset('dashboard/assets/css/pages/login/login-1.rtl.css')}}" rel="stylesheet" type="text/css" />
        ...
        <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
            ...
            <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                ...
                <a href="#" class="text-center mb-10">
                    <img src="{{asset('dashboard/assets/media/logos/logo-letter-1.png')}}" class="max-h-70px" alt="" />
                </a>
                <!--end::Aside header-->
                <!--begin::Aside title-->
...
<!--                            <span class="text-muted font-weight-bold font-size-h4">New Here?
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" class="form-control form-control-solid h-auto py-6 px-6 rounded-lg @error('email') is-invalid @enderror" type="email" value="{{ old('email') }}" name="email" required autocomplete="email" autofocus />
                        </div>
...
--}}
                            ...
                            <input id="password" class="form-control form-control-solid h-auto py-6 px-6 rounded-lg @error('password') is-invalid @enderror" type="password" name="password" required autocomplete="current-password"/>
                        </div>
...
<!--                <div class="login-form login-forgot">
                    ...
                    <form method="POST" action="{{ route('password.update') }}" class="form" novalidate="novalidate" id="kt_login_forgot_form">
                        @csrf
                        ...
                        <div class="form-group">
                            <input id="email" class="form-control form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6 @error('email') is-invalid @enderror" value="{{ $email ?? old('email') }}" type="email" placeholder="{{ __('E-Mail Address') }}" name="email" required autocomplete="email" autofocus />
                        </div>
