            ...
            <div class="row mb-2">
                ...
                {{--<div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.blogs.index')}}">@lang('site.blogs')</a></li>
                        <li class="breadcrumb-item active">@lang('site.add_blog')</li>
                    </ol>
                </div>--}}
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">إضافة كروت</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('carts.store') }}" method="post">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="cart_number" class="form-control" id="exampleInputEmail1">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">تاريخ الصلاحية</label>
...
@section('script')
    ...
    <script src="{{ asset('assets/admin/plugins/tinymce/tiny.js') }}"></script>
@endsection
