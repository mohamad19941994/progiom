        ...
        <div class="d-flex flex-column-fluid">
            ...
            <!--begin::Card-->
                <div class="card card-custom">
                    ...
                    <!--begin::Form-->
                    <form action="{{ route('dashboard.pages.update') }}" method="post">
                        {{ csrf_field() }}
                        {{ method_field('post') }}
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="term_name" type="text" class="form-control" value="{{ $page[0]->term_name }}" placeholder="@lang('site.title')"/>
                            </div>
                            {{--description--}}
                            <div class="form-group">
                                <label>@lang('site.description')</label>
                                <textarea name="term_description" class="form-control" id="mytextarea" rows="10" cols="10">{{$page[0]->term_description}}</textarea>
                            </div>
                        </div>
